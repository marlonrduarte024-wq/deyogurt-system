            ...
            <div key={p.id} className="bg-white p-4 rounded shadow space-y-2">
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    onChange={(e)=>cambiarEstado(p.id, e.target.checked ? "entregado":"pendiente")}
                  />
                </div>
              </div>
              ...
              {p.estado_pago!=="si" && (
                <div className="flex gap-2">
                  ...
                  />
                  <button className="bg-blue-600 text-white px-3 py-1 rounded" onClick={()=>registrarAbono(p.id)}>Abonar</button>
